...
class _RegisterDeliveryBoyScreenState extends State<RegisterDeliveryBoyScreen> {
  ...
  void toggleShowPasswordagain() {
    setState(() {
      showPasswordagain =
          !showPasswordagain; // Toggle the showPasswordagain flag
    });
  }

  getDecoration(String hint, IconData prefixIcon, {IconButton? suffixIcon}) {
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        ValueListenableBuilder(
                            ...
                            builder: (context, isProgress, child) {
...
setSnackbar(BuildContext context, String msg) {
